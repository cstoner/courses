...
SAME_IDENT_M = IF( 'male (?x)', THEN('same-identity (?x) (?x)'))
SAME_IDENT_F = IF( 'female (?x)', THEN('same-identity (?x) (?x)'))
...
BROTHER = IF( AND('parent (?x) (?y)', 'parent (?x) (?z)', 'male (?y)', NOT('same-identity (?y) (?z)')), THEN('brother (?y) (?z)'))
SISTER = IF( AND('parent (?x) (?y)', 'parent (?x) (?z)', 'female (?y)', NOT('same-identity (?y) (?z)')), THEN('sister (?y) (?z)'))
COUSINS_BROTHER = IF( AND('parent (?x) (?y)', 'parent (?a) (?b)', 'brother (?x) (?a)', NOT('same-identity (?y) (?b)')), THEN('cousin (?y) (?b)'))
COUSINS_SISTER = IF( AND('parent (?x) (?y)', 'parent (?a) (?b)', 'sister (?x) (?a)', NOT('same-identity (?y) (?b)')), THEN('cousin (?y) (?b)'))
GRANDPARENT = IF( AND('parent (?a) (?b)', 'parent (?b) (?c)'), THEN('grandparent (?a) (?c)'))
GRANDCHILD = IF( AND('parent (?a) (?b)', 'parent (?b) (?c)'), THEN('grandchild (?c) (?a)'))
# Then, put them together into a list in order, and call it
# family_rules.
family_rules = [ SAME_IDENT_M,
                 SAME_IDENT_F,
                 MOTHER,
                 FATHER,
                 DAUGHTER,
...
WHAT_I_FOUND_INTERESTING = 'The backchaining stuff was really interesting'
WHAT_I_FOUND_BORING = 'Writing the chaining rules for family stuff is pretty boring.'
